...
public class exec_frag extends Fragment {
    ...
    private exec_activity activity;
    private String kemu;

    public static exec_frag newInstance(ResultEntity resultEntity) {
        exec_frag newFragment = new exec_frag();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        activity = (exec_activity) getActivity();
