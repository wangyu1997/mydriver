...
public class cuoti_frag extends Fragment {
    ...
    Button btnCollect;
    private cuotiEntity resultEntity;
    private cuoti_activity activity;
    private String kemu;

    public static cuoti_frag newInstance(cuotiEntity resultEntity) {
        cuoti_frag newFragment = new cuoti_frag();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        activity = (cuoti_activity) getActivity();
    ...
    public void setResultEntity(cuotiEntity resultEntity) {
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                ...
                case MsgUtil.alreadyCorrect_sc:
                    ...
                    break;
                case MsgUtil.deleteCorrect_ct:
                    ToastUtil.toast("太好了,有消灭了一道错题!");
                    break;
            }
        ...
        switch (view.getId()) {
            ...
            case R.id.btn_submit:
                ...
                if (isRight) {
                    ...
                    updateBaseInfoProgress.setVisibility(View.VISIBLE);
                    btnSubmit.setEnabled(false);
                    CuotiUtil.delete(resultEntity, handler, MyApplication.jiazhaoID, kemu);
                } else {
