...
public class shoucang_activity extends FragmentActivity {
    ...
    private shoucang_frag_adapter mPagerAdapter;
    ...
    private void initViewPager() {
        ...
        //添加Fragment
        //适配器
        mPagerAdapter = new shoucang_frag_adapter(getSupportFragmentManager(), data);
    ...
    public void getQuestion() {
        ...
        ShoucangUtil.query(handler, MyApplication.jiazhaoID, kemu);
    }
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                ...
                case MsgUtil.queryNoneCorrect_sc:
                    ...
                    break;
                case MsgUtil.queryCorrect_sc:
                    data = new ArrayList<>();
                    List<shoucangEntity> list = (List<shoucangEntity>) msg.obj;
